...
open numSyntax pairLib pairTools lcsymtacs Abbrev;
HOL_Interactive.toggle_quietdec();
...
(*   let val thy         = (fst o fst o hd)(DB.find fn_str) *)
(*       val fn_tm       = prim_mk_const {Name=fn_str,   Thy=thy} *)
(*       val dest_fn     = dest_monop fn_tm (ERR (String.concat["dest_", fn_str]) "") *)
(*       val is_fn       = can dest_fn *)
(*  in  *)
...
(*     val ls = (map ((fn ls => append ls arg) o strip_pair o dest_fn) tls) *)
(*    in  *)
(*      (map_every (fn l => assume_tac (th |> tspec_let_elim l )) (ls)) (asl ,g)  *)
(*    end) *)
(* end; *)
